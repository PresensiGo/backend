...
func InitAttendanceHandlers() *injector.AttendanceHandlers {
	...
	attendanceHandlers := injector.NewAttendanceHandlers(handlersAttendance, handlersLateness)
...
func InitMajorHandlers() *injector3.MajorHandlers {
	db := database.New()
	major := services3.NewMajor(db)
	handlersMajor := handlers3.NewMajor(major)
