    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/responses.GetAllUsers"
                        }
                    }
                }
            }
        ...
        "/api/v1/batches/{batch_id}/majors/{major_id}/classrooms/{classroom_id}/subject-attendances/{subject_attendance_id}": {
            ...
            "delete": {
                ...
                "operationId": "DeleteSubjectAttendance",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "batch id",
        ...
        "/api/v1/batches/{batch_id}/majors/{major_id}/classrooms/{classroom_id}/subject-attendances/{subject_attendance_id}/records/{record_id}": {
            "delete": {
                ...
                "operationId": "DeleteSubjectAttendanceRecord",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "batch id",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/responses.DeleteSubjectAttendanceRecord"
                        }
                    }
                }
            }
